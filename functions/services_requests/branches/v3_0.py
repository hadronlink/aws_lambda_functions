...
table = dynamodb.Table('services_requests_dev')
table_chats = dynamodb.Table('chats_dev')
table_roles = dynamodb.Table('roles_dev')
table_quotes = dynamodb.Table('quotes_dev')
...
def update_item(payload):
    """
    Updates an item in the services_requests_dev table and cascades changes
    ...
    try:
        ...
        # Fetch the existing item from services_requests_dev
